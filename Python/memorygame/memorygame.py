...
class Window:
    ...
    def create_difficulty_buttons(self):
        self.easy_button = Button(tk, text= '簡単', width = 10, font = ('MS Gothic', 15), command = self._easy_button)
        self.easy_button.pack()
        self.easy_button.place(x = 700, y = 25)

        self.normal_button = Button(tk, text= '普通', width = 10, font = ('MS Gothic', 15), command = self._normal_button)
        self.normal_button.pack()
        self.normal_button.place(x = 850, y = 25)

        self.hard_button = Button(tk, text= '難しい', width = 10, font = ('MS Gothic', 15), command = self._hard_button)
        self.hard_button.pack()
        self.hard_button.place(x = 700,y = 75)

        self.very_hard_button = Button(tk, text= '超難しい', width = 10, font = ('MS Gothic', 15), command = self._very_hard_button)
        self.very_hard_button.pack()
        self.very_hard_button.place(x = 850, y = 75)
    ...
    def _disable_buttons(self):
        ...
        self.normal_button['state'] = 'disabled'
        self.hard_button['state'] = 'disabled'
        self.very_hard_button['state'] = 'disabled'

    def _enable_buttons(self):
        self.easy_button['state'] = 'normal'
        self.normal_button['state'] = 'normal'
        self.hard_button['state'] = 'normal'
        self.very_hard_button['state'] = 'normal'
...
class Card:
    def __init__(self, file_name):
        ...
        self.x = 0
        self.y = 0
        self.image_path = Path.cwd() / 'images' / file_name
        self.check_file_path_validity()
        self.image = PhotoImage(file = self.image_path)
        self.id = None

    def check_file_path_validity(self):
        if self.image_path.exists() is False:
            messagebox.showerror("Error!", f"{self.file_name} was not found.")
            tk.destroy()
            raise RuntimeError(f"{self.file_name} was not found.")
